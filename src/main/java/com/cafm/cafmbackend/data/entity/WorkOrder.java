...
import com.cafm.cafmbackend.data.converter.WorkOrderPriorityConverter;
import com.cafm.cafmbackend.data.converter.WorkOrderStatusConverter;
...
public class WorkOrder extends TenantAwareEntity {
    ...
    @Column(name = "priority", columnDefinition = "VARCHAR(50)")
    @Convert(converter = WorkOrderPriorityConverter.class)
    @org.hibernate.annotations.ColumnTransformer(write = "?::work_order_priority")
    private WorkOrderPriority priority = WorkOrderPriority.MEDIUM;
    
    @Column(name = "status", columnDefinition = "VARCHAR(50)")
    @Convert(converter = WorkOrderStatusConverter.class)
    @org.hibernate.annotations.ColumnTransformer(write = "?::work_order_status")
