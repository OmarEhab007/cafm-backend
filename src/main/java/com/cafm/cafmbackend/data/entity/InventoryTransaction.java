...
import com.cafm.cafmbackend.data.converter.InventoryTransactionTypeConverter;
...
public class InventoryTransaction extends BaseEntity {
    ...
    @Convert(converter = InventoryTransactionTypeConverter.class)
    @org.hibernate.annotations.ColumnTransformer(write = "?::inventory_transaction_type")
