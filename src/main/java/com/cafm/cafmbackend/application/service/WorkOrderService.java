...
public class WorkOrderService {
    ...
    public WorkOrderSimplifiedResponse createWorkOrder(WorkOrderCreateRequest request) {
        ...
        if (request.reportId() != null) {
            ...
            report.setStatus(com.cafm.cafmbackend.shared.enums.ReportStatus.IN_PROGRESS);
    ...
    public WorkOrderSimplifiedResponse completeWorkOrder(UUID id, String completionNotes) {
        ...
        if (workOrder.getReport() != null) {
            ...
            report.setStatus(com.cafm.cafmbackend.shared.enums.ReportStatus.COMPLETED);
     ...
     * Map report priority to work order priority.
     */
    private WorkOrderPriority mapReportPriority(com.cafm.cafmbackend.shared.enums.ReportPriority reportPriority) {
