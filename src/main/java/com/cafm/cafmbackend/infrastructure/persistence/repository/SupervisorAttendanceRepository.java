...
public interface SupervisorAttendanceRepository extends JpaRepository<SupervisorAttendance, UUID>, 
    ...
    /**
     * Find attendance records for a supervisor and check-in time range.
     */
    List<SupervisorAttendance> findBySupervisorIdAndCheckInTimeBetween(UUID supervisorId, LocalDateTime startTime, LocalDateTime endTime);
