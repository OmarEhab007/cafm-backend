...
import com.cafm.cafmbackend.infrastructure.persistence.entity.base.SoftDeletableEntity;
...
@NamedQueries({
    @NamedQuery(
        ...
        query = "SELECT c FROM Company c WHERE c.status = com.cafm.cafmbackend.shared.enums.CompanyStatus.ACTIVE AND c.isActive = true AND c.deletedAt IS NULL"
    ),
    @NamedQuery(
