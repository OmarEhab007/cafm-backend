...
public class AssetMaintenance extends TenantAwareEntity {
    ...
    @Column(name = "maintenance_number", unique = true, length = 50)
    private String maintenanceNumber;
    
    // Company association for multi-tenancy (inherited from TenantAwareEntity)
    ...
    // Warranty and planned maintenance flags
    @Column(name = "is_warranty_work")
    private Boolean isWarrantyWork = false;
