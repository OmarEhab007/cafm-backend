package com.cafm.cafmbackend.service.tenant;
...
public class TenantContextService {
    ...
    public record TenantInfo(
        UUID tenantId,
        String companyName,
        com.cafm.cafmbackend.data.enums.CompanyStatus status,
        com.cafm.cafmbackend.data.enums.SubscriptionPlan subscriptionPlan,
