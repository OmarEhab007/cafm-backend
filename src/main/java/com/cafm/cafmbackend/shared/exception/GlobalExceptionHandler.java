...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(
        ...
        auditService.logSecurityEvent(
            com.cafm.cafmbackend.infrastructure.persistence.entity.AuditLog.AuditAction.ACCESS_DENIED, 
    ...
    public ResponseEntity<ErrorResponse> handleMultiTenantViolationException(
        ...
        auditService.logSecurityEvent(
            com.cafm.cafmbackend.infrastructure.persistence.entity.AuditLog.AuditAction.TENANT_VIOLATION, 
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(
        ...
        auditService.logSecurityEvent(
            com.cafm.cafmbackend.infrastructure.persistence.entity.AuditLog.AuditAction.ERROR, 
